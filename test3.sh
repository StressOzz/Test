...
# =========================================
ZAPRET_MANAGER_VERSION="8.0"; ZAPRET_VERSION="72.20260111"; STR_VERSION_AUTOINSTALL="v6"
...
/opt/zapret/blockcheck.sh; start_zapret; else echo -e "\n${RED}Обновите ${NC}Zapret${RED} до последней версии!${NC}\n"; read -p "Нажмите Enter..." dummy; fi ;;
...
if [ "$INSTALLED_VER" = "не найдена" ]; then ZAPRET_MENU_ITEM="Установить"; elif [ "$INSTALLED_VER" != "$ZAPRET_VERSION" ]; then ZAPRET_MENU_ITEM="Обновить"; fi
echo -e "\n${CYAN}1) ${GREEN}$ZAPRET_MENU_ITEM${NC} Zapret\n${CYAN}2) ${GREEN}Меню стратегий${NC}\n${CYAN}3) ${GREEN}Вернуть ${NC}настройки по умолчанию\n${CYAN}4) ${GREEN}$str_stp_zpr ${NC}Zapret"
