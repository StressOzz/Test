...
9) doh_install && setup_doh "$doh_astracat" "dns.astracat.ru";; 10) doh_install && setup_doh "$doh_dnsai" "dns.dns-ai.ru";; 11) doh_install && setup_doh "$doh_mafioznik" "dns.mafioznik.xyz";; 12) doh_install && setup_doh "$doh_queryCF" "dns.malw.link (CloudFlare)";;
13) doh_install && setup_doh "$doh_nullsproxy" "dns.nullsproxy.com";; 14) doh_install && setup_doh "$doh_def" "настройки по умолчанию";; *) return;; esac; done; }
