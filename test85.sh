...
5) sh <(wget -O - https://raw.githubusercontent.com/StressOzz/Test/main/Zapret-Manager_v7.6.sh); exit 0 ;;
6) get_versions; uninstall_zapret "1"; ZAPRET_VERSION="72.20251022"; install_Zapret "1" ; ZAPRET_VERSION="72.20251227" ;;
