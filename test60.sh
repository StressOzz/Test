...
TMP_LIST="/opt/zapret_backup/zapret_yt_list.txt"; SAVED_STR="/opt/zapret_backup/StrYou"; OLD_STR="/opt/zapret_backup/StrOLD"
BACKUP_FILE="/opt/zapret_backup/hosts_temp.txt"; HOSTLIST_FILE="/opt/zapret/ipset/zapret-hosts-user.txt"
HOSTLIST_MIN_SIZE=1800000; FINAL_STR="/opt/zapret_backup/StrFINAL"; NEW_STR="/opt/zapret_backup/StrNEW"; HOSTS_USER="/opt/zapret_backup/hosts-user.txt"
