...
TMP_SF="/tmp/zapret_temp"; WORKDIR="$TMP_SF/zapret-update"
...
BACKUP_FILE="$TMP_SF/hosts_temp.txt"; STR_FILE="$TMP_SF/str_test.txt"; TEMP_FILE="$TMP_SF/str_temp.txt"
RESULTS="$TMP_SF/zapret_bench.txt"; BACK="$TMP_SF/zapret_back"
