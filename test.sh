...
URL_APK_MOD="https://github.com/badigit/MagiTrickle_mod_badigit/releases/download/${MOD_VERSION}/magitrickle_${MOD_VERSION_APK}-r1_openwrt_${ARCH}.apk"
...
#mihomo_editor {
    ...
    box-sizing: border-box;
        ...
        var editorContainer = E('textarea', {
    'id': 'mihomo_editor',
    'style': 'width:100%;height:60vh;font-family:monospace;padding:10px;resize:vertical;'
}, mainConfigContent);
...
editor = {
    getValue: function() {
        return document.getElementById('mihomo_editor').value;
    },

    setValue: function(v) {
        document.getElementById('mihomo_editor').value = v || '';
    },

    focus: function() {
        document.getElementById('mihomo_editor').focus();
    },

    navigateFileEnd: function() {
        var ta = document.getElementById('mihomo_editor');
