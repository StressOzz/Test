...
chk() { curl -"$1" -Is --connect-timeout 3 https://github.com >/dev/null 2>&1 && echo -ne "${GREEN}ok${NC}" || echo -ne "${RED}fail${NC}"; }

echo -n "GitHub IPv4: "; chk 4
echo -n "  IPv6: "; curl -6 -Is --connect-timeout 3 https://github.com >/dev/null 2>&1 \
