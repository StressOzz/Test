...
run_test_strategies() {
    ...
    "Discord|https://discord.com" "X|https://x.com" "Filmix|https://filmix.my" "FlightRadar24|https://flightradar24.com" "GooglePlay|https://play.google.com" \
    "Ottai|https://ottai.com" > "${OUT_DPI}.tmp"

    cat "$OUT_DPI" >> "${OUT_DPI}.tmp"
    mv "${OUT_DPI}.tmp" "$OUT_DPI"

    # --- Читаем финальный список URL для теста ---
    URLS="$(cat "$OUT_DPI")"
