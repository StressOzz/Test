...
ZAPRET_RESTART () { /etc/init.d/zapret stop; chmod +x /opt/zapret/sync_config.sh; /opt/zapret/sync_config.sh; /etc/init.d/zapret start; /etc/init.d/zapret restart >/dev/null 2>&1; }
