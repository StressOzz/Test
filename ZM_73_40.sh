...
for pkg in byedpi youtubeUnblock; do if opkg list-installed | grep -q "^$pkg"; then echo -e "\033[7m\n${RED}Найден установленный ${NC}\033[7m$pkg${RED}!${NC}\n\033[7mZapret${RED} может работать некорректно совместно с ${NC}\033[7m$pkg${RED}!${NC}"; fi; done
