...
if grep -q 'ct original packets ge 30 flow offload @ft;' /usr/share/firewall4/templates/ruleset.uc; then echo -e "\n${YELLOW}FIX для Flow Offloading:${NC}      ${GREEN}включён${NC}"; fi
