...
clear; echo -e "${MAGENTA}Системное меню${NC}\n\n${YELLOW}Используется зеркало: ${NC}$CURR"; if web_is_enabled; then echo -e "${YELLOW}Доступ из браузера:${NC} $LAN_IP:7681"; fi
...
3) set_mirror "mirror.tiguinet.net/openwrt" ;; 4) set_mirror "mirror.ps.kz/openwrt" ;; 5) set_mirror "ftp.snt.utwente.nl/pub/software/openwrt" ;; 6) set_mirror "mirrors.cicku.me/openwrt" ;; 7) set_mirror "downloads.openwrt.org" ;; *) break ;; esac; done; }
# ==========================================
# Главное меню
# ==========================================
