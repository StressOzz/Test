...
if hosts_enabled; then echo -e "${YELLOW}IP в hosts: ${RED}отсутствуют${NC}\n"; else echo -e "${YELLOW}IP в hosts: ${GREEN}добавлены${NC}\n"; fi
