...
echo 'sh <(wget -q -O - https://raw.githubusercontent.com/StressOzz/Test/main/t7.sh)' > /usr/bin/zms; chmod +x /usr/bin/zms
echo 'sh <(wget -q -O - https://raw.githubusercontent.com/StressOzz/Test/main/t7.sh) "$@"' > /usr/bin/zmsA; chmod +x /usr/bin/zmsA
...
BEST_NAME=$(echo "$BEST_LINE" | cut -d'→' -f1 | sed 's/[[:space:]]*$//'); echo "Лучшая стратегия: $BEST_LINE"; 
...
find "$BASE" -type f -name 'general*.bat' ! -name 'general (SIMPLE FAKE ALT2).bat' ! -name 'general (SIMPLE FAKE ALT).bat' ! -name 'general (FAKE TLS AUTO).bat' ! -name 'general (FAKE TLS AUTO ALT3).bat' ! -name 'general (ALT5).bat' ! -name 'general (ALT).bat' ! -name 'general (ALT10).bat' ! -name 'general (ALT11).bat' ! -name 'general (ALT12).bat' ! -name 'general (ALT2).bat' ! -name 'general (ALT3).bat' ! -name 'general (ALT4).bat' ! -name 'general (ALT5).bat' ! -name 'general (ALT6).bat' ! -name 'general (ALT7).bat' ! -name 'general (ALT8).bat' ! -name 'general (ALT9).bat' ! -name 'general (EXP).bat' ! -name 'general (SIMPLE FAKE).bat' ! -name 'general.bat' | while read -r F; do MATCH=$(grep -E '^--filter-udp=19294-19344,50000-50100|^--filter-tcp=%GameFilterTCP%|^--filter-udp=%GameFilterUDP%|^--filter-tcp=2053,2083,2087,2096,8443|^--filter-tcp=443 --hostlist="%LISTS%list-google.txt"|^--filter-tcp=80,443 --hostlist="%LISTS%list-general.txt"' "$F")
