...
strategy_CHOUSE () { echo -ne "\n${YELLOW}Введите версию стратегии (1-7):${NC} "; read -r choice; if [[ "$choice" =~ ^[1-7]$ ]]; then install_strategy "v$choice"; fi; }
